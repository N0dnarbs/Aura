...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	GameplayTags.Attributes_Primary_Resiliance = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Primary.Resiliance"),
	...
	*/
	...
	GameplayTags.Attributes_Secondary_CriticalHitDamage = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Bonus damage addedwhen critical hit is scored")
	);
